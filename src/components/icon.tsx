...
export type IconName = 'phone' | 'check' | 'x' | 'back' | 'leaf' | 'moon' | 'sun' | 'sliders';
...
export function Icon({ name, size = 24, stroke = 1.6, style }: IconProps): ReactElement {
  const p = {
    fill: 'none',
    stroke: 'currentColor',
    strokeWidth: stroke,
  ...
  const paths: Record<IconName, ReactElement> = {
    phone: (
      <>
        <rect {...p} x="7" y="2.5" width="10" height="19" rx="2.6" />
